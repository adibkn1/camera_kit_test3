<!DOCTYPE html><html class="default" lang="en"><head><meta charSet="utf-8"/><meta http-equiv="x-ua-compatible" content="IE=edge"/><title>CameraKitSource | CameraKit Web SDK - v0.15.0-alpha.1</title><meta name="description" content="Documentation for CameraKit Web SDK"/><meta name="viewport" content="width=device-width, initial-scale=1"/><link rel="stylesheet" href="../assets/style.css"/><link rel="stylesheet" href="../assets/highlight.css"/><script defer src="../assets/main.js"></script><script async src="../assets/search.js" id="tsd-search-script"></script></head><body><script>document.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"</script><header class="tsd-page-toolbar">
...
<li><span class="target">CameraKitSource</span></li></ul></section>
...
<li class="tsd-signature tsd-anchor-link" id="constructor.new_CameraKitSource"><span class="tsd-kind-constructor-signature">new <wbr/>Camera<wbr/>Kit<wbr/>Source</span><span class="tsd-signature-symbol">(</span><span class="tsd-kind-parameter">sourceInfo</span>, <span class="tsd-kind-parameter">subscriber</span><span class="tsd-signature-symbol">?</span>, <span class="tsd-kind-parameter">deviceInfo</span><span class="tsd-signature-symbol">?</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="CameraKitSource.html" class="tsd-signature-type tsd-kind-class">CameraKitSource</a><a href="#constructor.new_CameraKitSource" aria-label="Permalink" class="tsd-anchor-icon"><svg viewBox="0 0 24 24"><use href="#icon-anchor"></use></svg></a></li>
...
<div class="tsd-comment tsd-typography">
<h4>Todo</h4><p>Currently it&#39;s only valid to call <code>setRenderSize</code> after <code>CameraKitSession.play</code> has been called. This
...
<li><a href="CameraKitSource.html" class="current"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-128"></use></svg><span>Camera<wbr/>Kit<wbr/>Source</span></a></li>
