<!DOCTYPE html><html class="default" lang="en"><head><meta charSet="utf-8"/><meta http-equiv="x-ua-compatible" content="IE=edge"/><title>LensPerformanceMeasurement | CameraKit Web SDK - v0.15.0-alpha.1</title><meta name="description" content="Documentation for CameraKit Web SDK"/><meta name="viewport" content="width=device-width, initial-scale=1"/><link rel="stylesheet" href="../assets/style.css"/><link rel="stylesheet" href="../assets/highlight.css"/><script defer src="../assets/main.js"></script><script async src="../assets/search.js" id="tsd-search-script"></script></head><body><script>document.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"</script><header class="tsd-page-toolbar">
...
<li><a href="LensPerformanceMeasurement.html">LensPerformanceMeasurement</a></li></ul>
<h1>Class LensPerformanceMeasurement</h1></div>
<section class="tsd-panel tsd-comment">
<div class="tsd-comment tsd-typography"><p>Represents an ongoing measurement of rendering metrics.</p>
<p>An instance of this class is obtained by calling <a href="LensPerformanceMetrics.html#beginMeasurement" class="tsd-kind-method">beginMeasurement</a>. Then it may be
...
<li><span class="target">LensPerformanceMeasurement</span></li></ul></section>
...
<li class="tsd-signature tsd-anchor-link" id="constructor.new_LensPerformanceMeasurement"><span class="tsd-kind-constructor-signature">new <wbr/>Lens<wbr/>Performance<wbr/>Measurement</span><span class="tsd-signature-symbol">(</span><span class="tsd-kind-parameter">instances</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="LensPerformanceMeasurement.html" class="tsd-signature-type tsd-kind-class">LensPerformanceMeasurement</a><a href="#constructor.new_LensPerformanceMeasurement" aria-label="Permalink" class="tsd-anchor-icon"><svg viewBox="0 0 24 24"><use href="#icon-anchor"></use></svg></a></li>
<li class="tsd-description">
<div class="tsd-parameters">
<h4 class="tsd-parameters-title">Parameters</h4>
<ul class="tsd-parameter-list">
<li>
<h5><span class="tsd-kind-parameter">instances</span>: <span class="tsd-signature-type ">Set</span><span class="tsd-signature-symbol">&lt;</span><a href="LensPerformanceMeasurement.html" class="tsd-signature-type tsd-kind-class">LensPerformanceMeasurement</a><span class="tsd-signature-symbol">&gt;</span></h5></li></ul></div>
<h4 class="tsd-returns-title">Returns <a href="LensPerformanceMeasurement.html" class="tsd-signature-type tsd-kind-class">LensPerformanceMeasurement</a></h4></li></ul></section></section>
<section class="tsd-panel-group tsd-member-group">
<h2>Methods</h2>
<section class="tsd-panel tsd-member"><a id="measure" class="tsd-anchor"></a>
<h3 class="tsd-anchor-link"><span>measure</span><a href="#measure" aria-label="Permalink" class="tsd-anchor-icon"><svg viewBox="0 0 24 24"><use href="#icon-anchor"></use></svg></a></h3>
<ul class="tsd-signatures">
<li class="tsd-signature tsd-anchor-link" id="measure.measure-1"><span class="tsd-kind-call-signature">measure</span><span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="../interfaces/ComputedFrameMetrics.html" class="tsd-signature-type tsd-kind-interface">ComputedFrameMetrics</a><a href="#measure.measure-1" aria-label="Permalink" class="tsd-anchor-icon"><svg viewBox="0 0 24 24"><use href="#icon-anchor"></use></svg></a></li>
<li class="tsd-description">
<div class="tsd-comment tsd-typography"><p>Return a <a href="../interfaces/ComputedFrameMetrics.html" class="tsd-kind-interface">ComputedFrameMetrics</a> object, containing lens performance metrics.</p>
<p>This method may be called multiple times, each time reporting values computed since the time when this instance
was created.</p>
</div>
<h4 class="tsd-returns-title">Returns <a href="../interfaces/ComputedFrameMetrics.html" class="tsd-signature-type tsd-kind-interface">ComputedFrameMetrics</a></h4>
...
<li class="tsd-description">
<div class="tsd-comment tsd-typography"><p>Reset the measured perforamance statistics (averages, std deviations). This is equivalent to using
<a href="LensPerformanceMetrics.html#beginMeasurement" class="tsd-kind-method">beginMeasurement</a> to create a new LensPerformanceMeasurement instance, but may be
more convenient.</p>
</div>
...
<ul class="tsd-signatures">
<li class="tsd-signature tsd-anchor-link" id="end.end-1"><span class="tsd-kind-call-signature">end</span><span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">void</span><a href="#end.end-1" aria-label="Permalink" class="tsd-anchor-icon"><svg viewBox="0 0 24 24"><use href="#icon-anchor"></use></svg></a></li>
<li class="tsd-description">
<div class="tsd-comment tsd-typography"><p>Stop measuring performance statistics.</p>
...
<li><a href="#measure" class=""><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-2048"></use></svg><span>measure</span></a></li>
...
<li><a href="LensPerformanceMeasurement.html" class="current"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-128"></use></svg><span>Lens<wbr/>Performance<wbr/>Measurement</span></a></li>
