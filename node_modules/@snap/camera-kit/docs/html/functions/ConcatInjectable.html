<!DOCTYPE html><html class="default" lang="en"><head><meta charSet="utf-8"/><meta http-equiv="x-ua-compatible" content="IE=edge"/><title>ConcatInjectable | CameraKit Web SDK - v0.15.0-alpha.1</title><meta name="description" content="Documentation for CameraKit Web SDK"/><meta name="viewport" content="width=device-width, initial-scale=1"/><link rel="stylesheet" href="../assets/style.css"/><link rel="stylesheet" href="../assets/highlight.css"/><script defer src="../assets/main.js"></script><script async src="../assets/search.js" id="tsd-search-script"></script></head><body><script>document.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"</script><header class="tsd-page-toolbar">
...
<li><a href="ConcatInjectable.html">ConcatInjectable</a></li></ul>
<h1>Function ConcatInjectable</h1></div>
<section class="tsd-panel">
<ul class="tsd-signatures">
<li class="tsd-signature tsd-anchor-link" id="ConcatInjectable"><span class="tsd-kind-call-signature">Concat<wbr/>Injectable</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type tsd-kind-type-parameter">Token</span><span class="tsd-signature-symbol">, </span><span class="tsd-signature-type tsd-kind-type-parameter">Service</span><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol">(</span><span class="tsd-kind-parameter">token</span>, <span class="tsd-kind-parameter">fn</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type ">InjectableFunction</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-symbol">{</span><br/><span>    </span><span class="tsd-signature-symbol">[</span><span class="tsd-kind-type-parameter">T</span><span class="tsd-signature-symbol"> in </span><span class="tsd-signature-symbol">keyof </span><span class="tsd-signature-type tsd-kind-type-parameter">Token</span><span class="tsd-signature-symbol">]</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type tsd-kind-type-parameter">Service</span><span class="tsd-signature-symbol">[]</span><br/><span class="tsd-signature-symbol">}</span><span class="tsd-signature-symbol">, </span><span class="tsd-signature-symbol">[</span><span class="tsd-signature-symbol">]</span><span class="tsd-signature-symbol">, </span><span class="tsd-signature-type tsd-kind-type-parameter">Token</span><span class="tsd-signature-symbol">, </span><span class="tsd-signature-type tsd-kind-type-parameter">Service</span><span class="tsd-signature-symbol">[]</span><span class="tsd-signature-symbol">&gt;</span><a href="#ConcatInjectable" aria-label="Permalink" class="tsd-anchor-icon"><svg viewBox="0 0 24 24"><g stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round" id="icon-anchor"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></g></svg></a></li>
<li class="tsd-description">
<div class="tsd-comment tsd-typography"><p>Create an Injectable factory function without dependencies (i.e. the factory function has no arguments) that appends
a Service onto an existing array of Services of the same type.</p>
<p>Ex:</p>
<pre><code class="language-ts"><span class="hl-2">import</span><span class="hl-1"> { </span><span class="hl-0">myServiceFactory</span><span class="hl-1">, </span><span class="hl-0">MyService</span><span class="hl-1"> } </span><span class="hl-2">from</span><span class="hl-1"> </span><span class="hl-3">&#39;./my-service&#39;</span><br/><br/><span class="hl-4">const</span><span class="hl-1"> </span><span class="hl-6">createMyService</span><span class="hl-1"> = </span><span class="hl-5">ConcatInjectable</span><span class="hl-1">(</span><br/><span class="hl-1">  </span><span class="hl-0">myServiceFactory</span><span class="hl-1">.</span><span class="hl-0">token</span><span class="hl-1">,</span><br/><span class="hl-1">  (): </span><span class="hl-11">MyService</span><span class="hl-1"> </span><span class="hl-4">=&gt;</span><span class="hl-1"> { </span><span class="hl-2">return</span><span class="hl-1"> ... },</span><br/><span class="hl-1">)</span><br/><br/><span class="hl-7">// Consumers then do:</span><br/><span class="hl-4">const</span><span class="hl-1"> </span><span class="hl-6">myConsumingServiceFactory</span><span class="hl-1"> = </span><span class="hl-5">Injectable</span><span class="hl-1">(</span><br/><span class="hl-1">  </span><span class="hl-3">&#39;myConsumingService&#39;</span><span class="hl-1">,</span><br/><span class="hl-1">  [ </span><span class="hl-0">myServiceFactory</span><span class="hl-1">.</span><span class="hl-0">token</span><span class="hl-1"> ],</span><br/><span class="hl-1">  (</span><span class="hl-0">myServices</span><span class="hl-1">: </span><span class="hl-11">MyService</span><span class="hl-1">[]) </span><span class="hl-4">=&gt;</span><span class="hl-1"> { </span><span class="hl-2">return</span><span class="hl-1"> ... }</span><br/><span class="hl-1">)</span>
...
<div class="tsd-comment tsd-typography"><p>A string Token identifying an existing Service that has an Array type, to which will be appended the
...
<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type ">InjectableFunction</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-symbol">{</span><br/><span>    </span><span class="tsd-signature-symbol">[</span><span class="tsd-kind-type-parameter">T</span><span class="tsd-signature-symbol"> in </span><span class="tsd-signature-symbol">keyof </span><span class="tsd-signature-type tsd-kind-type-parameter">Token</span><span class="tsd-signature-symbol">]</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type tsd-kind-type-parameter">Service</span><span class="tsd-signature-symbol">[]</span><br/><span class="tsd-signature-symbol">}</span><span class="tsd-signature-symbol">, </span><span class="tsd-signature-symbol">[</span><span class="tsd-signature-symbol">]</span><span class="tsd-signature-symbol">, </span><span class="tsd-signature-type tsd-kind-type-parameter">Token</span><span class="tsd-signature-symbol">, </span><span class="tsd-signature-type tsd-kind-type-parameter">Service</span><span class="tsd-signature-symbol">[]</span><span class="tsd-signature-symbol">&gt;</span></h4>
<div class="tsd-comment tsd-typography"></div></li>
<li class="tsd-signature tsd-anchor-link" id="ConcatInjectable-1"><span class="tsd-kind-call-signature">Concat<wbr/>Injectable</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type tsd-kind-type-parameter">Token</span><span class="tsd-signature-symbol">, </span>const <span class="tsd-signature-type tsd-kind-type-parameter">Tokens</span><span class="tsd-signature-symbol">, </span><span class="tsd-signature-type tsd-kind-type-parameter">Params</span><span class="tsd-signature-symbol">, </span><span class="tsd-signature-type tsd-kind-type-parameter">Service</span><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol">(</span><span class="tsd-kind-parameter">token</span>, <span class="tsd-kind-parameter">dependencies</span>, <span class="tsd-kind-parameter">fn</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type ">InjectableFunction</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type ">ServicesFromTokenizedParams</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type tsd-kind-type-parameter">Tokens</span><span class="tsd-signature-symbol">, </span><span class="tsd-signature-type tsd-kind-type-parameter">Params</span><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol">, </span><span class="tsd-signature-type tsd-kind-type-parameter">Tokens</span><span class="tsd-signature-symbol">, </span><span class="tsd-signature-type tsd-kind-type-parameter">Token</span><span class="tsd-signature-symbol">, </span><span class="tsd-signature-type tsd-kind-type-parameter">Service</span><span class="tsd-signature-symbol">[]</span><span class="tsd-signature-symbol">&gt;</span><a href="#ConcatInjectable-1" aria-label="Permalink" class="tsd-anchor-icon"><svg viewBox="0 0 24 24"><use href="#icon-anchor"></use></svg></a></li>
<li class="tsd-description">
<div class="tsd-comment tsd-typography"><p>Create an Injectable factory function with dependencies (i.e. the factory function has arguments) that appends
a Service onto an existing array of Services of the same type.</p>
<p>Ex:</p>
<pre><code class="language-ts"><span class="hl-2">import</span><span class="hl-1"> { </span><span class="hl-0">myServiceFactory</span><span class="hl-1">, </span><span class="hl-0">MyService</span><span class="hl-1"> } </span><span class="hl-2">from</span><span class="hl-1"> </span><span class="hl-3">&#39;./my-service&#39;</span><br/><br/><span class="hl-4">const</span><span class="hl-1"> </span><span class="hl-6">createMyService</span><span class="hl-1"> = </span><span class="hl-5">ConcatInjectable</span><span class="hl-1">(</span><br/><span class="hl-1">  </span><span class="hl-0">myServiceFactory</span><span class="hl-1">.</span><span class="hl-0">token</span><span class="hl-1">,</span><br/><span class="hl-1">  [</span><span class="hl-3">&#39;DependencyA&#39;</span><span class="hl-1">, </span><span class="hl-3">&#39;DependencyB&#39;</span><span class="hl-1">],</span><br/><span class="hl-1">  (</span><span class="hl-0">a</span><span class="hl-1">: </span><span class="hl-11">A</span><span class="hl-1">, </span><span class="hl-0">b</span><span class="hl-1">: </span><span class="hl-11">B</span><span class="hl-1">): </span><span class="hl-11">MyService</span><span class="hl-1"> </span><span class="hl-4">=&gt;</span><span class="hl-1"> { </span><span class="hl-2">return</span><span class="hl-1"> ... },</span><br/><span class="hl-1">)</span><br/><br/><span class="hl-7">// Consumers then do:</span><br/><span class="hl-4">const</span><span class="hl-1"> </span><span class="hl-6">myConsumingServiceFactory</span><span class="hl-1"> = </span><span class="hl-5">Injectable</span><span class="hl-1">(</span><br/><span class="hl-1">  </span><span class="hl-3">&#39;myConsumingService&#39;</span><span class="hl-1">,</span><br/><span class="hl-1">  [ </span><span class="hl-0">myServiceFactory</span><span class="hl-1">.</span><span class="hl-0">token</span><span class="hl-1"> ],</span><br/><span class="hl-1">  (</span><span class="hl-0">myServices</span><span class="hl-1">: </span><span class="hl-11">MyService</span><span class="hl-1">[]) </span><span class="hl-4">=&gt;</span><span class="hl-1"> { </span><span class="hl-2">return</span><span class="hl-1"> ... }</span><br/><span class="hl-1">)</span>
</code><button>Copy</button></pre>
</div>
<section class="tsd-panel">
<h4>Type Parameters</h4>
...
<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type tsd-kind-type-parameter">Service</span></h4></li></ul></li></ul></li></ul></div>
<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type ">InjectableFunction</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type ">ServicesFromTokenizedParams</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type tsd-kind-type-parameter">Tokens</span><span class="tsd-signature-symbol">, </span><span class="tsd-signature-type tsd-kind-type-parameter">Params</span><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol">, </span><span class="tsd-signature-type tsd-kind-type-parameter">Tokens</span><span class="tsd-signature-symbol">, </span><span class="tsd-signature-type tsd-kind-type-parameter">Token</span><span class="tsd-signature-symbol">, </span><span class="tsd-signature-type tsd-kind-type-parameter">Service</span><span class="tsd-signature-symbol">[]</span><span class="tsd-signature-symbol">&gt;</span></h4>
...
<li><a href="ConcatInjectable.html" class="current"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>Concat<wbr/>Injectable</span></a></li>
