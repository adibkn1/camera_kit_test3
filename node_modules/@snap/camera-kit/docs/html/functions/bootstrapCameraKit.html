<!DOCTYPE html><html class="default" lang="en"><head><meta charSet="utf-8"/><meta http-equiv="x-ua-compatible" content="IE=edge"/><title>bootstrapCameraKit | CameraKit Web SDK - v0.15.0-alpha.1</title><meta name="description" content="Documentation for CameraKit Web SDK"/><meta name="viewport" content="width=device-width, initial-scale=1"/><link rel="stylesheet" href="../assets/style.css"/><link rel="stylesheet" href="../assets/highlight.css"/><script defer src="../assets/main.js"></script><script async src="../assets/search.js" id="tsd-search-script"></script></head><body><script>document.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"</script><header class="tsd-page-toolbar">
...
<li><a href="bootstrapCameraKit.html">bootstrapCameraKit</a></li></ul>
<h1>Function bootstrapCameraKit</h1></div>
<section class="tsd-panel">
<ul class="tsd-signatures">
<li class="tsd-signature tsd-anchor-link" id="bootstrapCameraKit"><span class="tsd-kind-call-signature">bootstrap<wbr/>Camera<wbr/>Kit</span><span class="tsd-signature-symbol">(</span><span class="tsd-kind-parameter">configuration</span>, <span class="tsd-kind-parameter">provide</span><span class="tsd-signature-symbol">?</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type ">Promise</span><span class="tsd-signature-symbol">&lt;</span><a href="../classes/CameraKit.html" class="tsd-signature-type tsd-kind-class">CameraKit</a><span class="tsd-signature-symbol">&gt;</span><a href="#bootstrapCameraKit" aria-label="Permalink" class="tsd-anchor-icon"><svg viewBox="0 0 24 24"><g stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round" id="icon-anchor"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></g></svg></a></li>
<li class="tsd-description">
<div class="tsd-comment tsd-typography"><p>Bootstrap CameraKit. This will download the WebAssembly code which powers CameraKit&#39;s rendering engine, and return
...
<li>
<h5><span class="tsd-kind-parameter">configuration</span>: <a href="../interfaces/CameraKitBootstrapConfiguration.html" class="tsd-signature-type tsd-kind-interface">CameraKitBootstrapConfiguration</a></h5>
<div class="tsd-comment tsd-typography"><p>Configure CameraKit with e.g. credentials, global resource endpoints, etc.</p>
</div>
<div class="tsd-comment tsd-typography"></div></li>
<li>
<h5><code class="tsd-tag ts-flagOptional">Optional</code> <span class="tsd-kind-parameter">provide</span>: <span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">(</span><span class="tsd-kind-parameter">c</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol"> =&gt; </span><a href="../types/PublicContainer.html" class="tsd-signature-type tsd-kind-type-alias">PublicContainer</a><span class="tsd-signature-symbol">)</span></h5>
<div class="tsd-comment tsd-typography"><p>Optional function that can make modifications to CameraKit&#39;s root DI container.</p>
</div>
<div class="tsd-comment tsd-typography"></div>
<ul class="tsd-parameters">
<li class="tsd-parameter-signature">
<ul class="tsd-signatures">
<li class="tsd-signature"><span class="tsd-signature-symbol">(</span><span class="tsd-kind-parameter">c</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="../types/PublicContainer.html" class="tsd-signature-type tsd-kind-type-alias">PublicContainer</a></li>
<li class="tsd-description">
<div class="tsd-parameters">
<h4 class="tsd-parameters-title">Parameters</h4>
<ul class="tsd-parameter-list">
<li>
<h5><span class="tsd-kind-parameter">c</span>: <a href="../types/PublicContainer.html" class="tsd-signature-type tsd-kind-type-alias">PublicContainer</a></h5></li></ul></div>
<h4 class="tsd-returns-title">Returns <a href="../types/PublicContainer.html" class="tsd-signature-type tsd-kind-type-alias">PublicContainer</a></h4></li></ul></li></ul></li></ul></div>
<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type ">Promise</span><span class="tsd-signature-symbol">&lt;</span><a href="../classes/CameraKit.html" class="tsd-signature-type tsd-kind-class">CameraKit</a><span class="tsd-signature-symbol">&gt;</span></h4><p>A <a href="../classes/CameraKit.html" class="tsd-kind-class">CameraKit</a> instance, which is the entry point to CameraKit&#39;s API.</p>
...
<li><a href="bootstrapCameraKit.html" class="current"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>bootstrap<wbr/>Camera<wbr/>Kit</span></a></li>
