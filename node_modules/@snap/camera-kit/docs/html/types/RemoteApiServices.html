...
<li><a href="RemoteApiServices.html">RemoteApiServices</a></li></ul>
<h1>Type alias RemoteApiServices</h1></div>
<div class="tsd-signature"><span class="tsd-kind-type-alias">Remote<wbr/>Api<wbr/>Services</span><span class="tsd-signature-symbol">:</span> <a href="../interfaces/RemoteApiService.html" class="tsd-signature-type tsd-kind-interface">RemoteApiService</a><span class="tsd-signature-symbol">[]</span></div></div>
...
<li><a href="RemoteApiServices.html" class="current"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-4194304"></use></svg><span>Remote<wbr/>Api<wbr/>Services</span></a></li>
