...
<li><a href="CameraKitSession.html">CameraKitSession</a></li></ul>
<h1>Class CameraKitSession</h1></div>
<section class="tsd-panel tsd-comment">
<div class="tsd-comment tsd-typography"><p>A CameraKitSession represents a single rendering pipeline connecting an input media source to output <code>&lt;canvas&gt;</code>
...
<li><span class="target">CameraKitSession</span></li></ul></section>
...
<div class="tsd-signature"><span class="tsd-kind-property">playing</span><span class="tsd-signature-symbol">:</span> <span class="tsd-signature-symbol">{ </span><br/><span>    </span><span class="tsd-kind-property">live</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">boolean</span><span class="tsd-signature-symbol">; </span><br/><span>    </span><span class="tsd-kind-property">capture</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">boolean</span><span class="tsd-signature-symbol">; </span><br/><span class="tsd-signature-symbol">}</span></div>
...
<ul class="tsd-parameters">
<li class="tsd-parameter">
<h5><span class="tsd-kind-property">live</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">boolean</span></h5></li>
<li class="tsd-parameter">
<h5><span class="tsd-kind-property">capture</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">boolean</span></h5></li></ul></div>
<div class="tsd-comment tsd-typography"></div></section>
...
<li class="tsd-signature tsd-anchor-link" id="applyLens.applyLens-1"><span class="tsd-kind-call-signature">apply<wbr/>Lens</span><span class="tsd-signature-symbol">(</span><span class="tsd-kind-parameter">lens</span>, <span class="tsd-kind-parameter">launchData</span><span class="tsd-signature-symbol">?</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type ">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">boolean</span><span class="tsd-signature-symbol">&gt;</span><a href="#applyLens.applyLens-1" aria-label="Permalink" class="tsd-anchor-icon"><svg viewBox="0 0 24 24"><use href="#icon-anchor"></use></svg></a></li>
...
<li>
<h5><code class="tsd-tag ts-flagOptional">Optional</code> <span class="tsd-kind-parameter">launchData</span>: <a href="../interfaces/LensLaunchData.html" class="tsd-signature-type tsd-kind-interface">LensLaunchData</a></h5></li></ul></div>
...
<ul class="tsd-parameter-list">
<li>
<h5><span class="tsd-kind-parameter">source</span>: <a href="CameraKitSource.html" class="tsd-signature-type tsd-kind-class">CameraKitSource</a></h5>
