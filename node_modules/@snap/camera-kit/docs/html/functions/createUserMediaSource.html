<!DOCTYPE html><html class="default" lang="en"><head><meta charSet="utf-8"/><meta http-equiv="x-ua-compatible" content="IE=edge"/><title>createUserMediaSource | CameraKit Web SDK - v0.15.0-alpha.1</title><meta name="description" content="Documentation for CameraKit Web SDK"/><meta name="viewport" content="width=device-width, initial-scale=1"/><link rel="stylesheet" href="../assets/style.css"/><link rel="stylesheet" href="../assets/highlight.css"/><script defer src="../assets/main.js"></script><script async src="../assets/search.js" id="tsd-search-script"></script></head><body><script>document.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"</script><header class="tsd-page-toolbar">
...
<li class="tsd-signature tsd-anchor-link" id="createUserMediaSource"><span class="tsd-kind-call-signature">create<wbr/>User<wbr/>Media<wbr/>Source</span><span class="tsd-signature-symbol">(</span><span class="tsd-kind-parameter">constraints</span><span class="tsd-signature-symbol">?</span>, <span class="tsd-kind-parameter">options</span><span class="tsd-signature-symbol">?</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type ">Promise</span><span class="tsd-signature-symbol">&lt;</span><a href="../classes/CameraKitSource.html" class="tsd-signature-type tsd-kind-class">CameraKitSource</a><span class="tsd-signature-symbol">&gt;</span><a href="#createUserMediaSource" aria-label="Permalink" class="tsd-anchor-icon"><svg viewBox="0 0 24 24"><g stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round" id="icon-anchor"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></g></svg></a></li>
<li class="tsd-description">
<div class="tsd-comment tsd-typography"><p>Create a <a href="../classes/CameraKitSource.html" class="tsd-kind-class">CameraKitSource</a> from a user&#39;s media device -- this calls
<a href="https://developer.mozilla.org/en-US/docs/Web/API/MediaDevices/getUserMedia">MediaDevices.getUserMedia</a> to get a
MediaStream and then calls <a href="createMediaStreamSource.html" class="tsd-kind-function">createMediaStreamSource</a>.</p>
</div>
<div class="tsd-parameters">
<h4 class="tsd-parameters-title">Parameters</h4>
<ul class="tsd-parameter-list">
<li>
<h5><span class="tsd-kind-parameter">constraints</span>: <span class="tsd-signature-type ">MediaStreamConstraints</span><span class="tsd-signature-symbol"> = ...</span></h5>
<div class="tsd-comment tsd-typography"><p>Specify contraints used to get a MediaStream from a media device. By default we simply request
a video stream.</p>
</div>
<div class="tsd-comment tsd-typography"></div></li>
<li>
<h5><span class="tsd-kind-parameter">options</span>: <a href="../types/CameraKitSourceOptions.html" class="tsd-signature-type tsd-kind-type-alias">CameraKitSourceOptions</a><span class="tsd-signature-symbol">&lt;</span><a href="../interfaces/MediaStreamSourceOptions.html" class="tsd-signature-type tsd-kind-interface">MediaStreamSourceOptions</a><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol"> = {}</span></h5>
<div class="tsd-comment tsd-typography"></div></li></ul></div>
<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type ">Promise</span><span class="tsd-signature-symbol">&lt;</span><a href="../classes/CameraKitSource.html" class="tsd-signature-type tsd-kind-class">CameraKitSource</a><span class="tsd-signature-symbol">&gt;</span></h4><p>A Promise, resolving to <a href="../classes/CameraKitSource.html" class="tsd-kind-class">CameraKitSource</a></p>

<div class="tsd-comment tsd-typography">
<h4>Deprecated</h4><p>The helper will be removed in one of the future releases.
Consumer apps are responsible for acquiring a media stream,
which can then be supplied to <a href="createMediaStreamSource.html" class="tsd-kind-function">createMediaStreamSource</a>.</p>
...
<li><a href="createUserMediaSource.html" class="current"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-64"></use></svg><span>create<wbr/>User<wbr/>Media<wbr/>Source</span></a></li>
