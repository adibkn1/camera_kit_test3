...
<li><a href="LensImagePickerError.html">LensImagePickerError</a></li></ul>
<h1>Type alias LensImagePickerError</h1></div>
<div class="tsd-signature"><span class="tsd-kind-type-alias">Lens<wbr/>Image<wbr/>Picker<wbr/>Error</span><span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type ">NamedError</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">&quot;LensImagePickerError&quot;</span><span class="tsd-signature-symbol">&gt;</span></div>
<div class="tsd-comment tsd-typography"><p>The error triggered when a lens prompts the user to select an image, but the image fails to be successfully delivered
to the lens.</p>
</div>
...
<li><a href="LensImagePickerError.html" class="current"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-4194304"></use></svg><span>Lens<wbr/>Image<wbr/>Picker<wbr/>Error</span></a></li>
