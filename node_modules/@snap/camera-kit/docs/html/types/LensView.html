...
<li><a href="LensView.html">LensView</a></li></ul>
<h1>Type alias LensView</h1></div>
<div class="tsd-signature"><span class="tsd-kind-type-alias">Lens<wbr/>View</span><span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type ">MakeTaggedBusinessEvent</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">&quot;lensView&quot;</span><span class="tsd-signature-symbol">&gt;</span></div>
<div class="tsd-comment tsd-typography"><p>The LensView metric is emitted after a lens has been viewed (for longer than 100ms), when the lens is turned off.</p>
...
<li><a href="LensView.html" class="current"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-4194304"></use></svg><span>Lens<wbr/>View</span></a></li>
