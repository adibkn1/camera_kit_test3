<!DOCTYPE html><html class="default" lang="en"><head><meta charSet="utf-8"/><meta http-equiv="x-ua-compatible" content="IE=edge"/><title>ComputedFrameMetrics | CameraKit Web SDK - v0.15.0-alpha.1</title><meta name="description" content="Documentation for CameraKit Web SDK"/><meta name="viewport" content="width=device-width, initial-scale=1"/><link rel="stylesheet" href="../assets/style.css"/><link rel="stylesheet" href="../assets/highlight.css"/><script defer src="../assets/main.js"></script><script async src="../assets/search.js" id="tsd-search-script"></script></head><body><script>document.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"</script><header class="tsd-page-toolbar">
...
<li><span class="target">ComputedFrameMetrics</span></li></ul></section>
...
<div class="tsd-index-list"><a href="ComputedFrameMetrics.html#avgFps" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><g id="icon-1024"><rect fill="var(--color-icon-background)" stroke="#FF984D" stroke-width="1.5" x="1" y="1" width="22" height="22" rx="12"></rect><path d="M9.354 16V7.24H12.174C12.99 7.24 13.638 7.476 14.118 7.948C14.606 8.412 14.85 9.036 14.85 9.82C14.85 10.604 14.606 11.232 14.118 11.704C13.638 12.168 12.99 12.4 12.174 12.4H10.434V16H9.354ZM10.434 11.428H12.174C12.646 11.428 13.022 11.284 13.302 10.996C13.59 10.7 13.734 10.308 13.734 9.82C13.734 9.324 13.59 8.932 13.302 8.644C13.022 8.356 12.646 8.212 12.174 8.212H10.434V11.428Z" fill="var(--color-text)"></path></g></svg><span>avg<wbr/>Fps</span></a>
...
<h2>Properties</h2>
<section class="tsd-panel tsd-member"><a id="avgFps" class="tsd-anchor"></a>
<h3 class="tsd-anchor-link"><span>avg<wbr/>Fps</span><a href="#avgFps" aria-label="Permalink" class="tsd-anchor-icon"><svg viewBox="0 0 24 24"><g stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round" id="icon-anchor"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></g></svg></a></h3>
<div class="tsd-signature"><span class="tsd-kind-property">avg<wbr/>Fps</span><span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">number</span></div></section>
<section class="tsd-panel tsd-member"><a id="lensFrameProcessingTimeMsAvg" class="tsd-anchor"></a>
<h3 class="tsd-anchor-link"><span>lens<wbr/>Frame<wbr/>Processing<wbr/>Time<wbr/>Ms<wbr/>Avg</span><a href="#lensFrameProcessingTimeMsAvg" aria-label="Permalink" class="tsd-anchor-icon"><svg viewBox="0 0 24 24"><use href="#icon-anchor"></use></svg></a></h3>
<div class="tsd-signature"><span class="tsd-kind-property">lens<wbr/>Frame<wbr/>Processing<wbr/>Time<wbr/>Ms<wbr/>Avg</span><span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">number</span></div></section>
<section class="tsd-panel tsd-member"><a id="lensFrameProcessingTimeMsStd" class="tsd-anchor"></a>
<h3 class="tsd-anchor-link"><span>lens<wbr/>Frame<wbr/>Processing<wbr/>Time<wbr/>Ms<wbr/>Std</span><a href="#lensFrameProcessingTimeMsStd" aria-label="Permalink" class="tsd-anchor-icon"><svg viewBox="0 0 24 24"><use href="#icon-anchor"></use></svg></a></h3>
<div class="tsd-signature"><span class="tsd-kind-property">lens<wbr/>Frame<wbr/>Processing<wbr/>Time<wbr/>Ms<wbr/>Std</span><span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">number</span></div></section>
<section class="tsd-panel tsd-member"><a id="lensFrameProcessingTimeMsMedian" class="tsd-anchor"></a>
<h3 class="tsd-anchor-link"><span>lens<wbr/>Frame<wbr/>Processing<wbr/>Time<wbr/>Ms<wbr/>Median</span><a href="#lensFrameProcessingTimeMsMedian" aria-label="Permalink" class="tsd-anchor-icon"><svg viewBox="0 0 24 24"><use href="#icon-anchor"></use></svg></a></h3>
<div class="tsd-signature"><span class="tsd-kind-property">lens<wbr/>Frame<wbr/>Processing<wbr/>Time<wbr/>Ms<wbr/>Median</span><span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">number</span></div></section>
<section class="tsd-panel tsd-member"><a id="lensFrameProcessingN" class="tsd-anchor"></a>
<h3 class="tsd-anchor-link"><span>lens<wbr/>Frame<wbr/>ProcessingN</span><a href="#lensFrameProcessingN" aria-label="Permalink" class="tsd-anchor-icon"><svg viewBox="0 0 24 24"><use href="#icon-anchor"></use></svg></a></h3>
<div class="tsd-signature"><span class="tsd-kind-property">lens<wbr/>Frame<wbr/>ProcessingN</span><span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">number</span></div></section></section></div>
...
<div class="tsd-accordion-details">
<ul>
<li><a href="#avgFps" class=""><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-1024"></use></svg><span>avg<wbr/>Fps</span></a></li>
<li><a href="#lensFrameProcessingTimeMsAvg" class=""><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-1024"></use></svg><span>lens<wbr/>Frame<wbr/>Processing<wbr/>Time<wbr/>Ms<wbr/>Avg</span></a></li>
<li><a href="#lensFrameProcessingTimeMsStd" class=""><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-1024"></use></svg><span>lens<wbr/>Frame<wbr/>Processing<wbr/>Time<wbr/>Ms<wbr/>Std</span></a></li>
<li><a href="#lensFrameProcessingTimeMsMedian" class=""><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-1024"></use></svg><span>lens<wbr/>Frame<wbr/>Processing<wbr/>Time<wbr/>Ms<wbr/>Median</span></a></li>
<li><a href="#lensFrameProcessingN" class=""><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-1024"></use></svg><span>lens<wbr/>Frame<wbr/>ProcessingN</span></a></li></ul></div></details></div>
<div class="site-menu">
...
<li><a href="ComputedFrameMetrics.html" class="current"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-256"></use></svg><span>Computed<wbr/>Frame<wbr/>Metrics</span></a></li>
