<!DOCTYPE html><html class="default" lang="en"><head><meta charSet="utf-8"/><meta http-equiv="x-ua-compatible" content="IE=edge"/><title>Lens | CameraKit Web SDK - v0.15.0-alpha.1</title><meta name="description" content="Documentation for CameraKit Web SDK"/><meta name="viewport" content="width=device-width, initial-scale=1"/><link rel="stylesheet" href="../assets/style.css"/><link rel="stylesheet" href="../assets/highlight.css"/><script defer src="../assets/main.js"></script><script async src="../assets/search.js" id="tsd-search-script"></script></head><body><script>document.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"</script><header class="tsd-page-toolbar">
...
<li><span class="target">Lens</span></li></ul></section>
...
<div class="tsd-comment tsd-typography"><p>Non-empty identifier of a unique lens available to be applied in current session.</p>
...
<div class="tsd-comment tsd-typography"><p>Human readable name of this lens.</p>
<p>NOTE: This value may contain unsafe characters
and therefore may require additional processing depending on usages.</p>
</div>
<div class="tsd-comment tsd-typography"></div></section>
<section class="tsd-panel tsd-member"><a id="iconUrl" class="tsd-anchor"></a>
<h3 class="tsd-anchor-link"><span>icon<wbr/>Url</span><a href="#iconUrl" aria-label="Permalink" class="tsd-anchor-icon"><svg viewBox="0 0 24 24"><use href="#icon-anchor"></use></svg></a></h3>
<div class="tsd-signature"><span class="tsd-kind-property">icon<wbr/>Url</span><span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">string</span></div>
<div class="tsd-comment tsd-typography"><p>Icon resource URI that represents this lens if available.</p>
</div>
<div class="tsd-comment tsd-typography"></div></section>
<section class="tsd-panel tsd-member"><a id="vendorData" class="tsd-anchor"></a>
<h3 class="tsd-anchor-link"><span>vendor<wbr/>Data</span><a href="#vendorData" aria-label="Permalink" class="tsd-anchor-icon"><svg viewBox="0 0 24 24"><use href="#icon-anchor"></use></svg></a></h3>
<div class="tsd-signature"><span class="tsd-kind-property">vendor<wbr/>Data</span><span class="tsd-signature-symbol">:</span> <span class="tsd-signature-symbol">{ </span><br/><span>    </span>[<span class="tsd-kind-index-signature">key</span>: <span class="tsd-signature-type">string</span>]<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">; </span><br/><span class="tsd-signature-symbol">}</span></div>
<div class="tsd-comment tsd-typography"><p>Vendor specific metadata associated with this lens, empty by default.</p>
...
<div class="tsd-comment tsd-typography"></div></section>
<section class="tsd-panel tsd-member"><a id="cameraFacingPreference" class="tsd-anchor"></a>
<h3 class="tsd-anchor-link"><span>camera<wbr/>Facing<wbr/>Preference</span><a href="#cameraFacingPreference" aria-label="Permalink" class="tsd-anchor-icon"><svg viewBox="0 0 24 24"><use href="#icon-anchor"></use></svg></a></h3>
<div class="tsd-signature"><span class="tsd-kind-property">camera<wbr/>Facing<wbr/>Preference</span><span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type ">Lens_CameraFacing</span></div>
<div class="tsd-comment tsd-typography"><p>Specifies a [Lens_CameraFacing] that this lens is designed for.</p>
</div>
<div class="tsd-comment tsd-typography"></div></section>
<section class="tsd-panel tsd-member"><a id="preview" class="tsd-anchor"></a>
<h3 class="tsd-anchor-link"><span>preview</span><a href="#preview" aria-label="Permalink" class="tsd-anchor-icon"><svg viewBox="0 0 24 24"><use href="#icon-anchor"></use></svg></a></h3>
<div class="tsd-signature"><span class="tsd-kind-property">preview</span><span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><a href="Preview.html" class="tsd-signature-type tsd-kind-interface">Preview</a></div>
<div class="tsd-comment tsd-typography"><p>Preview representing this lens, if available.</p>
</div>
<div class="tsd-comment tsd-typography"></div></section>
<section class="tsd-panel tsd-member"><a id="lensCreator" class="tsd-anchor"></a>
<h3 class="tsd-anchor-link"><span>lens<wbr/>Creator</span><a href="#lensCreator" aria-label="Permalink" class="tsd-anchor-icon"><svg viewBox="0 0 24 24"><use href="#icon-anchor"></use></svg></a></h3>
<div class="tsd-signature"><span class="tsd-kind-property">lens<wbr/>Creator</span><span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type ">LensCreator</span></div>
<div class="tsd-comment tsd-typography"><p>Information about the lens creator.</p>
</div>
<div class="tsd-comment tsd-typography"></div></section>
<section class="tsd-panel tsd-member"><a id="snapcode" class="tsd-anchor"></a>
<h3 class="tsd-anchor-link"><span>snapcode</span><a href="#snapcode" aria-label="Permalink" class="tsd-anchor-icon"><svg viewBox="0 0 24 24"><use href="#icon-anchor"></use></svg></a></h3>
<div class="tsd-signature"><span class="tsd-kind-property">snapcode</span><span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><a href="Snapcode.html" class="tsd-signature-type tsd-kind-interface">Snapcode</a></div>
...
<li><a href="Lens.html" class="current"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-256"></use></svg><span>Lens</span></a></li>
