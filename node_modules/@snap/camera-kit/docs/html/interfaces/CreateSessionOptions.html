...
<div class="tsd-comment tsd-typography"><p>Options available when creating a <a href="../classes/CameraKitSession.html" class="tsd-kind-class">CameraKitSession</a>.</p>
</div>
<div class="tsd-comment tsd-typography"></div></section>
<section class="tsd-panel tsd-hierarchy">
<h4>Hierarchy</h4>
<ul class="tsd-hierarchy">
<li><span class="target">CreateSessionOptions</span></li></ul></section>
...
<div class="tsd-index-list"><a href="CreateSessionOptions.html#liveRenderTarget" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><g id="icon-1024"><rect fill="var(--color-icon-background)" stroke="#FF984D" stroke-width="1.5" x="1" y="1" width="22" height="22" rx="12"></rect><path d="M9.354 16V7.24H12.174C12.99 7.24 13.638 7.476 14.118 7.948C14.606 8.412 14.85 9.036 14.85 9.82C14.85 10.604 14.606 11.232 14.118 11.704C13.638 12.168 12.99 12.4 12.174 12.4H10.434V16H9.354ZM10.434 11.428H12.174C12.646 11.428 13.022 11.284 13.302 10.996C13.59 10.7 13.734 10.308 13.734 9.82C13.734 9.324 13.59 8.932 13.302 8.644C13.022 8.356 12.646 8.212 12.174 8.212H10.434V11.428Z" fill="var(--color-text)"></path></g></svg><span>live<wbr/>Render<wbr/>Target?</span></a>
...
<h2>Properties</h2>
<section class="tsd-panel tsd-member"><a id="liveRenderTarget" class="tsd-anchor"></a>
<h3 class="tsd-anchor-link"><code class="tsd-tag ts-flagOptional">Optional</code> <span>live<wbr/>Render<wbr/>Target</span><a href="#liveRenderTarget" aria-label="Permalink" class="tsd-anchor-icon"><svg viewBox="0 0 24 24"><g stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round" id="icon-anchor"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5"></path></g></svg></a></h3>
<div class="tsd-signature"><span class="tsd-kind-property">live<wbr/>Render<wbr/>Target</span><span class="tsd-signature-symbol">?:</span> <span class="tsd-signature-type ">HTMLCanvasElement</span></div>
<div class="tsd-comment tsd-typography"><p>Optionally provide an existing canvas element, on which the Live RenderTarget will be rendered.</p>
<p>If this is not provided, CameraKit will create a new canvas element which can be added to the DOM.</p>
</div>
<div class="tsd-comment tsd-typography"></div></section>
<section class="tsd-panel tsd-member"><a id="renderWhileTabHidden" class="tsd-anchor"></a>
<h3 class="tsd-anchor-link"><code class="tsd-tag ts-flagOptional">Optional</code> <span>render<wbr/>While<wbr/>Tab<wbr/>Hidden</span><a href="#renderWhileTabHidden" aria-label="Permalink" class="tsd-anchor-icon"><svg viewBox="0 0 24 24"><use href="#icon-anchor"></use></svg></a></h3>
<div class="tsd-signature"><span class="tsd-kind-property">render<wbr/>While<wbr/>Tab<wbr/>Hidden</span><span class="tsd-signature-symbol">?:</span> <span class="tsd-signature-type">boolean</span></div>
<div class="tsd-comment tsd-typography"><p>Browsers optimize tabs when they are hidden - for example, by pausing the execution of requestAnimationFrame
callbacks.</p>
...
<div class="tsd-accordion-details">
<ul>
<li><a href="#liveRenderTarget" class=""><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-1024"></use></svg><span>live<wbr/>Render<wbr/>Target</span></a></li>
<li><a href="#renderWhileTabHidden" class=""><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-1024"></use></svg><span>render<wbr/>While<wbr/>Tab<wbr/>Hidden</span></a></li></ul></div></details></div>
<div class="site-menu">
